...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserModel
        fields = ['is_instructor', 'username', 'email', 'phone', 'first_name', 'last_name', 'gender', 'date_of_birth',
    ...
    def validate(self, attrs):
        ...
        if delta < 18:
            raise serializers.ValidationError({'date_of_birth': 'Возраст должен быть более 18 лет.'})
