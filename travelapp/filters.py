...
class TripFilter(filters.FilterSet):
    ...
    district = filters.NumberFilter(field_name='route', lookup_expr='location__district')
    ...
    class Meta:
        model = Trip
        fields = ['min_price', 'max_price', 'starts_after', 'starts_before', 'ends_after', 'ends_before', 'instructor',
                  # by route
                  'route', 'region', 'district', 'route_type', 'complexity', 'min_duration', 'max_duration']